    ...
    const fetchIncome = async () => {
      try {
       ...
       let expenseAmountArr=[]
        ...
        // var union = [...new Set([...expenseDateArr, ...incomeDateArr])];
        // console.log(incomeChartArr);
        
        
        console.log(incomeChartArr);
        
     console.log(incomeChart.date);
         ...
         <div className='col-span-9  bg-red-100 m-5 rounded-xl p-5'>
           <div className='grid grid-cols-12'>
             ...
             <div className="col-span-5 ml-8">
               ...
               <Expense money={"120"} label={"Dentist"}></Expense>
               <Expense money={"3000"} label={"Travelling"}></Expense>
               <Income money={"1300"} label={"Freenlancing"}></Income>
