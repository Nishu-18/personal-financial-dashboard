...
export function Dashboard(){
  ...
  const name=localStorage.getItem("name")
    ...
    return (<div className='grid grid-cols-12 '>
        ...
        }} className=' md:hidden'><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
        <path stroke-linecap="round" stroke-linejoin="round" d="M3.75 6.75h16.5M3.75 12h16.5m-16.5 5.25h16.5" />
        </svg>
      </button>
        <div id='sidebar' className=' transform -translate-x-full bg-red-100 rounded-xl p-5 m-5 col-span-3 h-70 hidden md:block md:relative md:translate-x-0'>
