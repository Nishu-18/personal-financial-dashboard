  ...
  useEffect(() => {
    const fetchIncome = async () => {
      ...
      try {
        ...
        let totalAmount=0
        const userDetail=await axios.get("http://localhost:3000/api/v1/user/getDetails",{
          headers:{Authorization:`Bearer ${token}`}
        })
        setDetail(userDetail.data.userDetails[0].goals);
            ...
            <div className='grid grid-cols-12'>
              <div className='col-span-3'>
                ...
                <button onClick={async function(){
                    ...
                    userDetail.map( async function(item){
                      await axios.post("http://localhost:3000/api/v1/expense/addExpense",{
                        title:item.name +" goal",type:"Towards Goal",amount:(amount*item.percent)/100,date
                      },{
                        headers:{Authorization:`Bearer ${token}`}
                      })
              ...
              <div className='col-span-9'>
                  ...
                  //   console.log(item.percent + item.name);
